...
async function getAuthRequest(req: Request, res: Response) {
   ...
   * [
  {
    ...
    "query": {
      ...
      "context": "https://d2x9th3e9lh990.cloudfront.net/schemas/69f2321354e8b21a41474d8d/proofofidentity_1.jsonld",
      "credentialSubject": {
        "name": {}
      },
  ...
  const proofRequest1 = {
    ...
    query: {
      allowedIssuers: ["*"],
      context:
        "https://d2x9th3e9lh990.cloudfront.net/schemas/69f2321354e8b21a41474d8d/proofofidentity_1.jsonld",
      credentialSubject: {
        name: {},
      },
      type: "proofofidentity",
  ...
  const proofRequest2 = {
    ...
    query: {
      allowedIssuers: ["*"],
      context:
        "https://d2x9th3e9lh990.cloudfront.net/schemas/69ef87c7d511037ccea0cc15/proofofhuman_1.jsonld",
      credentialSubject: {
        name: {},
      },
      type: "proofofhuman",
  ...
  //     allowedIssuers: ["*"],
  //     context:
  //       "https://raw.githubusercontent.com/vkpatva/jsonschema/refs/heads/main/testing-file.json",
  //     type: "testingschema",
  //     credentialSubject: {
  //       "attribute.height": {
  //         $ne: 1,
  ...
  //     allowedIssuers: ["*"],
  //     context:
  //       "https://raw.githubusercontent.com/vkpatva/jsonschema/refs/heads/main/result-json-ld.json",
  //     type: "Result",
  //     credentialSubject: {
  //       "marks.IT443.theory": {
  //         $ne: 1,
